              ...
              Positioned(
                  ...
                  child: Container(
                    ...
                    child: TextButton(
                      ...
                      onPressed: () {},
                      child:Align(alignment: Alignment.center,child: Center(child: Image.asset("image/bus21.png"))),
                    ),
                  ),),
              Positioned(
                  bottom: MediaQuery.of(context).size.height * 0.1,
                  ...
                  child: Container(
                    ...
                    child: TextButton(
                      ...
                      onPressed: () {add;},
                      child: Align(alignment: Alignment.center,child:Text("+",textAlign: TextAlign.center,
                          style: TextStyle(
                              fontSize: 75,
                              color: Color.fromRGBO(249, 224, 5, 1),
                              fontWeight: FontWeight.bold)),
